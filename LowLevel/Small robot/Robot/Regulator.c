...
float stopVelFast[5] = {0.75, 0.10, -0.2, 1.5, 2.5}; //{0.2,0.1,-0.05,0.2,0.7};            //движение с остановкой в точке
float standVelFast[5] = {0.75, 0.6, -0.6, 2.0, 2.5};                                       //удержание заданного положения

float normalVelSlow[5] = {0.4, 0.2, 0.2, 1.5, 2.5};//V_уст, V_нач, V_кон, А_уск, А_торм  //непрерывное движение
float stopVelSlow[5] = {0.45, 0.03, -0.05, 1.2, 2.0}; //{0.2,0.1,-0.05,0.2,0.7};            //движение с остановкой в точке
