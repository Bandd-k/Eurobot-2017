...
float stopVelFast[5] = {0.75, 0.13, -0.2, 1.5, 2.5}; //{0.2,0.1,-0.05,0.2,0.7};            //движение с остановкой в точке
...
float stopVelSlow[5] = {0.4, 0.05, -0.05, 1.6, 2.5}; //{0.2,0.1,-0.05,0.2,0.7};            //движение с остановкой в точке
